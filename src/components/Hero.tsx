...
const Hero: React.FC = () => {
  ...
  const backgroundImages = [
    ...
    'https://images.unsplash.com/photo-1740657254989-42fe9c3b8cce?q=80&w=3412&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
  ];
